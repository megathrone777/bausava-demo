			...
			<tbody>
				<?php foreach ($houses as $house): ?>
					<tr>
						...
						<td>
							...
							<button
								...
								data-bs-toggle="modal"
								data-bs-target="#delete-house-<?= $house->id; ?>"
								type="button"
							>
										...
										<div class="mb-5">
											...
											>
												<?php
													...
													foreach($houseFeatures as $featureIndex => $houseFeature):
												?>
													<div
														class="
															align-items-center
													...
													>
														...
														>
															<?php
																include $_SERVER["DOCUMENT_ROOT"] . "/src/web/icons/" . $houseFeature->icon . ".php";
															?>
														</div>
												...
												<?php
													includeWith(
														...
														array(
															...
															"editorValue" => trim($house->description)
														)
													);
												?>
											</div>
					...
					>
						<div class="modal-dialog">
							<form
								action="/src/admin/helpers/houses/delete.php"
								class="form-delete"
								method="POST"
							>
								<div class="modal-content">
									...
									<div class="modal-body">
										...
										<p>Вы уверены, что хотите удалить <?= $house->title; ?>?</p>
									</div>
