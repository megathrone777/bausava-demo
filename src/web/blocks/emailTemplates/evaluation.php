		...
		<html lang="cs">
			...
			<body>
				<div class="wrapper">
					...
					<p>
						<strong>Typ: byt / dům: </strong>
						<span><?= $fields["type"]; ?></span>
					</p>

					<p>
						<strong>Lokalita (město/část): </strong>
						<span><?= $fields["location"]; ?></span>
					</p>

					<p>
						<strong>Plocha v m<sup>2</sup>: </strong>
						<span><?= $fields["square"]; ?></span>
					</p>

					<p>
						<strong>Kontakt (e-mail / telefon): </strong>
