...
<template data-js-if="categoryId === '<?= $category->id; ?>' && initialProjects.length === 0">
	<div class="contents">
...
<template data-js-if="initialProjects.length > 0">
	<div class="contents">
		<template
			data-js-key="`project-${project.id}`"
			data-js-for="(project, projectIndex) in initialProjects"
		>
			<div
				class="
